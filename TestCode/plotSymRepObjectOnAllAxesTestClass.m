...
%             returns5 = copy(returns2);
            ...
            plotSymRepObjectOnAllAxes(Ax, symbObj4,returns6.timeDateTime, false, true,40, get(ph(1), 'Color'));
            
            [Ax, ~, ph] = plotmdtsObject(returns6, 'plotSymbolName', true, 'plotSymbolDuration', true);
            plotSymRepObjectOnAllAxes(Ax, symbObj4,returns6.timeDateTime, true, false,40, get(ph(1), 'Color'));
            
            [Ax, ~, ph] = plotmdtsObject(returns6, 'plotSymbolName', true, 'plotSymbolDuration', true);
            plotSymRepObjectOnAllAxes(Ax, symbObj4,returns6.timeDateTime, true, true,40, get(ph(1), 'Color'));
 
            [Ax, ~, ph] = plotmdtsObject(returns6, 'plotSymbolName', true, 'plotSymbolDuration', true);
            plotSymRepObjectOnAllAxes(Ax, symbObj4,returns6.timeDateTime, false, false,0, get(ph(1), 'Color'));
...
%       
            ...
            %[~, ~, ~] = plotmdtsObject(returns, 'bUseDateTime', false, 'bUseTimeRelative', true);
                        
        end
        
%         function testRelativeTimeStamps(testCase)
%             
%             nX = 1000;
%             nChannels = 4;
%             
