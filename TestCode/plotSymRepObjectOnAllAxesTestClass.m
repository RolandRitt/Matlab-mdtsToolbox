classdef plotSymRepObjectOnAllAxesTestClass < matlab.unittest.TestCase
    %
    ...
    methods (Test)
        ...
        function testFunctionality(testCase)
            ...
            plotSymRepObjectOnAllAxes(Ax, symbObj4,returns6.timeDateTime, 'plotSymbolName', true,'plotSymbolNameMinLength',40 , 'plotSymbolDuration', false, 'colorDismiss', get(ph(1), 'Color'));
            
            [Ax, ~, ph] = plotmdtsObject(returns6, 'plotSymbolName', true, 'plotSymbolDuration', true);
            plotSymRepObjectOnAllAxes(Ax, symbObj4,returns6.timeDateTime, 'plotSymbolName', false,'plotSymbolNameMinLength',40 , 'plotSymbolDuration', true, 'colorDismiss', get(ph(1), 'Color'));
            
            [Ax, ~, ph] = plotmdtsObject(returns6, 'plotSymbolName', true, 'plotSymbolDuration', true);
            plotSymRepObjectOnAllAxes(Ax, symbObj4,returns6.timeDateTime, 'plotSymbolName', true,'plotSymbolNameMinLength',40 , 'plotSymbolDuration', true, 'colorDismiss', get(ph(1), 'Color'));
            
            [Ax, ~, ph] = plotmdtsObject(returns6, 'plotSymbolName', true, 'plotSymbolDuration', true);
            plotSymRepObjectOnAllAxes(Ax, symbObj4,returns6.timeDateTime, 'plotSymbolName', true, 'plotSymbolDuration', true, 'colorDismiss', get(ph(1), 'Color'));
