classdef segmentChannelTestClass < matlab.unittest.TestCase
    %
    ...
    methods (Test)
        ...
        function testSegmentation(testCase)
            ...
            segObj2 = segmentChannel(input2, edges2, alphabet2);  
            segObj3 = segmentChannel(input3, edges3, alphabet3); 
          
            testCase.verifyEqual(segObj1.durations, expectedReturn1.durations);
            testCase.verifyEqual(segObj1.symbols, expectedReturn1.symbols);
            
            testCase.verifyEqual(segObj2.durations, expectedReturn2.durations);
            testCase.verifyEqual(segObj2.symbols, expectedReturn2.symbols);
            
            testCase.verifyEqual(segObj3.durations, expectedReturn3.durations);
            testCase.verifyEqual(segObj3.symbols, expectedReturn3.symbols);
