classdef plotmdtsObjectTestClass < matlab.unittest.TestCase
    ...
    methods (Test)
        ...
        function testFunctionality(testCase)
            ...
            input2.object = returns0;
            input2.tag = 'Channel 2';
            alphabet2 = {'b'};
            edges2 = [-4, 4];
            
            input3.object = returns0;
            ...
            returns0 = returns0.addSymbRepToChannel(returns0.getTagIndices(input1.tag), symbObj1);
            returns0 = returns0.addSymbRepToChannel(returns0.getTagIndices(input2.tag), symbObj2);
