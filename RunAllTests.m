...
% 
% %% Run Tests
% % allTests = 'D:\GitRepos\MatlabGitRepos\Global\IAToolboxes\mdtsToolbox';
% % results = runtests(pwd)

%%
pathFile  = fileparts(mfilename('fullpath'));
tests = matlab.unittest.TestSuite.fromFolder(pathFile,'IncludingSubfolders', true);
result = run(tests)