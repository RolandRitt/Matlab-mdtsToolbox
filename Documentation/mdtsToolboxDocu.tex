...
\end{lstlisting}
additional datetimes and tags/alias names can be used for indexing
\begin{lstlisting}[frame=single]
newObject = originalObject({datetime(2019,8,12), datetime(2019,9,12) },{'tag1', 'tag3'}); % all data extracted between 2019-08-12 and 2019-09-12 (including start and end date), columns (channels) with name 'tag1' and 'tag3'

newObject = originalObject(:,{'tag1', 'tag3'}); % all data extracted for columns (channels) with name 'tag1' and 'tag3'

newObject = originalObject({datetime(2019,8,12), datetime(2019,9,12) },:); % all data extracted between 2019-08-12 and 2019-09-12 (including start and end date), all columns 
\end{lstlisting}
