...
\begin{enumerate}
	...
	\item \textbf{other key-value pairs}: re forwarded to the plotMulti function of the graphics-toolbox.
\end{enumerate}
returned are:
\begin{enumerate}
	\item \textbf{axesH}: the handles to the axes
...
\item \textbf{[axesOut, fM, ph] = plotSegmentsOnAxes(axesIn, segmentTag, varargin)}\\
