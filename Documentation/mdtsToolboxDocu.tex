...
\begin{lstlisting}[frame=single]
newObject = originalObject({datetime(2019,8,12), datetime(2019,9,12) },{'tag1', 'tag2'}); % all data extracted between 2019-08-12 and 2019-09-12 (including start and end date), columns (channels) with name 'tag1' and 'tag3'
newObject = originalObject(1 : 4, 2 : 3); % time stamps 1 - 4, tags 2 - 3
newObject = originalObject(4, 1 : 3); % time stamp 4, tags 1 - 3
newObject = originalObject(2 : 5, 2); % time stamps 2 - 5, tag 2
\end{lstlisting}
