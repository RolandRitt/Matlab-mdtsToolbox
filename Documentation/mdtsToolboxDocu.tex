...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\item \textbf{plotSegDuration}:optional key-value pair;  minimum number of datapoints (duration) within a segment to annotate the segment name and/or duration
		\item \textbf{additional key-value pairs}: these are forwarded to the Matlab
	\end{enumerate}
	returned are:
	\begin{enumerate}
