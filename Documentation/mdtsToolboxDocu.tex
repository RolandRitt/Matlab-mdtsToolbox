...
\subsection{FigureManager_hierarchicalSymRep}
	A subclass of FigureManager (see FigureManager toolbox). This is used to visualize hierarchical symbolic analysis. This is used in the function \textit{visuHierarchicalSymRep}-see \ref{ssec:visuHierarchicalSymRep}
