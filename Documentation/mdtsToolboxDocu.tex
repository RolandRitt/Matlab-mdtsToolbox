...
\begin{enumerate}
	\item \textbf{[startInds, durations] = obj.findSymbol(symbol)}\\
		...
		returned are:
		\begin{enumerate}
			\item \textbf{startInds}: the start indices of the occurrances of the symbol within the symbolic representation. The indices are with respect to the datapoint indices.
		\end{enumerate}
