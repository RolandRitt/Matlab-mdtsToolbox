...
\begin{enumerate}
	...
	\item \textbf{markovM =  SymbObj.genLengthWeightedMatrix(varargin)}\\
	...
	\item \textbf{symbMarkov = SymbObj.genSymbMarkov(varargin)}\\
	...
	\item \textbf{markovM = SymbObj.genWeightedMatrixChangedLength(varargin)}\\
