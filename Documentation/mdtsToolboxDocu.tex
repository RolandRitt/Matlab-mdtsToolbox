...
\begin{enumerate}
	\item \textbf{[startInds, durations, repetitions] = obj.findSymbol(symbol)}\\
		...
		\begin{enumerate}
			...
			\item \textbf{durations}: the durations of the occurrances of the symbol within the symbolic representation. The indices are with respect to the datapoints and not to the compressed symbolic structure.
			\item \textbf{repetitions}: the durations of the occurrances of the symbol within the symbolic representation. The indices are with respect to the datapoints and not to the compressed symbolic structure.
		\end{enumerate}
