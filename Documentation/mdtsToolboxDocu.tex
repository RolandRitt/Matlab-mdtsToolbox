...
\item \textbf{isTagList = isTag(obj, tags)}\\
...
\item \textbf{obj =  setAliasTable(obj, tIn)}\\
...
\item \textbf{isInList = isAlias(obj, tags)}\\
This function checks if the given \textit{tags} are aliases defined in the aliasTable. A logical array \textit{isInList} of the same size as \textit{tags} is returned, indicating which tags are aliases.
